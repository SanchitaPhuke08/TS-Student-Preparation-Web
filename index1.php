...
<html lang="en">
  <head>
    ...
    <meta http-equiv="refresh" content="1200000000000000;URL=index.php" />
            ...
            <div class="container"  >
                ...
                <div class="row" style="margin-left:300px;">
                    ...
                    <a class="remove-anchor-style" href="../StudPrep/Relax-Zone/music.html">
                        <div class="work-box overlay shadow">
                            ...
                            <div class="work-icon">
                               <center> <i class="fa fa-music"></i> </center>
                            </div>
                ...
                <a class="remove-anchor-style" href="../StudPrep/Relax-Zone/TicTac.php">
                    <div class="work-box overlay shadow">
                        ...
                        <div class="work-icon">
                           <center> <i class="fas fa-chess-board"></i> </center>
                        </div>
                        <h2>TIC TAC TOE</h2>
                        <p>
                        Users can prioritize tasks and work efficiently through the portal which will help to increase productivity by tracking the tasks in progress record.
...
<script>
    ...
    setInterval(()=>{
        ...
        setTimeout(()=>{body.style.display = 'none'}, 1200000)}, 30000000)
    </script>
